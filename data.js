...
const G = {
    ...
    challenges: [
      {
        ...
        options: [
          ...
          { text: "ورش عمل مجتمعية لإعادة التدوير", desc: "لقاءات أسبوعية يتعلم فيها كبار السن فصل النفايات", risk: "منخفض — بسيط واجتماعي وتفاعلي", best: true, points: 5 },
          ...
          { text: "آلة بلاستيكية تلقائية في الأحياء", desc: "آلات تُحوّل البلاستيك لمكافآت صغيرة", risk: "مرتفع — تكلفة عالية وصعوبة صيانة", best: false, points: 2 }
        ],
        correctIndex: 1
      },
      {
        ...
        options: [
          { text: "منصة رقمية تُحوّل تجميع البلاستيك لنقاط مكافأة", desc: "تُستخدم لشراء قسائم مطاعم ومتاجر الحرم", risk: "منخفض — يجمع بين اللعب والمتعة", best: true, points: 5 },
          ...
          { text: "حملة تصوير بالهاتف للمواطنين", desc: "يصورون البلاستيك ويشاركونه على منصات التواصل", risk: "متوسط — توعية لكن لا حل عملي", best: false, points: 3 },
      ...
      },
      {
        ...
        hint: "تلميح: أصحاب المشاريع يبحثون عن حلول تُحسّن أعمالهم.",
        ...
        options: [
          ...
          { text: "شراكة مع جامعات لتخفيض الرسوم", desc: "التواصل مع الجامعات لتوفير خصومات", risk: "متوسط — جيد لكن يحتاج وقتًا طويلًا", best: false, points: 3 },
      ...
      },
      {
        ...
        hint: "تلميح: الأمهات يحتاجن حلول سريعة ومريحة — لا يملكن وقتًا طويلًا.",
      ...
      },
      {
        ...
        hint: "تلميح: الموظفون عن بُعد يعانون من العزلة — حل يجمع الناس.",
        ...
        options: [
          ...
          { text: "عمل عن بُعد بالكامل — بدون مكتب", desc: "الشركة تلغي المكتب وتعمل من البيت", risk: "مرتفع — يزيد العزلة", best: false, points: 1 },
          { text: "خط سير سريع للموظفين فقط", desc: "مخصص للموظفين في ساعات الذروة", risk: "مرتفع — تكلفة هائلة وغير عملية", best: false, points: 2 }
        ],
        correctIndex: 0
      },
      {
        ...
        options: [
          { text: "تطبيق وصفات من بقايا الوجبات", desc: "يُحوّل ما تبقى في الثلاجة لوصفة جديدة", risk: "منخفض — عملي ومباشر ويُقلل الهدر", best: true, points: 5 },
  ...
  personalities: {
    ...
    innovator_strategic: {
      ...
      advice: "تخطيطك ممتاز — لكن أحياناً التحليل الزائد يُؤدي لفو Opportunities. لا تنتظر الكمال قبل البدء."
    },
    innovator_creative: {
